<%@ Page Title="" Language="C#" MasterPageFile="~/SmileMaster.Master" AutoEventWireup="true" CodeBehind="Smile_Shop_AdminUpdate.aspx.cs" Inherits="EADPProject.Smile_Shop_AdminUpdate" %>
    ...
    <form id="formUpdate" runat="server">
        ...
        <section class="addProduct">
            <div class="container">
                ...
                <asp:Button ID="BtnUpdate" class="btn btn_3" runat="server" OnClick="BtnUpdate_Click" Text="Update" Width="86px" />
